  ...
  <svelte:fragment slot="content">
    ...
    <section id="Befehlsschema">
      <section>
        <h2>1. Lage</h2>
          <section>
            ...
            <h3>1.2) Eigene Lage</h3>
              ...
              <br>
              <br>
              <div use:exampleBox><p>„<i>Ein mechanisierter Infanteriezug und ein Infanteriehalbzug der Task Force Hellcat befinden sich aktuell im Verfügungsraum <span use:tooltip data-tooltip="Meter">5000</span> östlich von Kavala. Absicht des Zugführers ist der Angriff in <b>drei</b> Phasen. In <b>Phase 1</b> nimmt der erste mechanisierte Halbzug den Südwesten Kavalas, der zweite mechanisierte Halbzug den Nordosten Kavalas. In <b>Phase 2</b> verteidigt der erste mechanisierte Halbzug den Südwesten Kavalas, der zweite mechanisierte Halbzug verteidigt den Nordosten Kavalas. In <b>Phase 3</b> nimmt der Infanteriehalbzug das Zentrum Kavalas. Absicht des Angriffs ist der Zugang zu einer zentralen Hafenanlage der Insel Altis.</i>“</p></div>
            ...
            <h3>1.3) Zivile Lage</h3>
              ...
              <br>
              <br>
              <div use:exampleBox><p>„<i>Die Zivilbevölkerung im Raum Kavala geht dem Alltäglichen nach. Zivilisten meiden den Kontakt zu feindlichen Kräften und treten den eigenen Kräften neutral gegenüber.</i>“</p></div>
          </section>
        ...
        <h2>4. Einsatzunterstützung</h2>
          <section>
            <h3>4.1) Logistische Unterstützung</h3>
              <p>In diesem Punkt wird über Maßnahmen und Einrichtungen der <span use:tooltip data-tooltip="z.B. Munition und SanMat für Soldaten oder Instandhaltung der Fahrzeuge">Versorgung</span> informiert.</p>
              <br>
              <br>
              <div use:exampleBox><p>„<i>Verbrauchsmaterial und Ersatzketten befinden sich auf den Schützenpanzern der mechanisierten Infanterie. Zur Versorgung des Infanteriehalbzuges steht ein Unimog mit Verbrauchsmaterial bereit.</i>“</p></div>
            ...
            <h3>4.2) Sanitätsdienstliche Unterstützung</h3>
              ...
              <br>
              <br>
              <div use:exampleBox><p>„<i>Vorrangig erfolgt die Versorgung verwundeter Soldaten im Feld durch Selbst- und Kameradenhilfe. Jeder Panzergrenadiertrupp und beide Gruppen des Infanteriehalbzuges verfügen jeweils über einen Sanitäter. Für medizinische Notfälle steht ein <span use:tooltip data-tooltip="kurz: BAT">beweglicher Arzttrupp</span> aufgesessen auf einem Unimog bereit.</i>“</p></div>
          </section>

        <h2>5. Führungsunterstützung</h2>
          <section>
            <h3>Funkverbindungsplan</h3>
              ...
              <br>
              <br>
              <div use:exampleBox><p>„<i>Der Kompaniekreis befindet sich auf der SEM 70 mit der Frequenz 60.000 MHz. Im Zugkreis wird das Funkgerät AN/PRC-152 verwendet. Dabei ist für den mechanisierten Infanteriezug Kanal 01 und für den Infanteriehalbzug Kanal 02 reserviert. Auf Gruppenebene wird mit der SEM 52 SL gefunkt. Für die vier Gruppen des mechanisierten Infanteriezuges sind Kanäle 01 bis 04 reserviert. Der Infanteriehalbzug verteilt sich auf den Kanälen 05 und 06.</i>“</p>
              <br>
              <br>
              <p>„<i>Der mechanisierte Infanteriezug ist in ALPHA und der Infanteriehalbzug in BRAVO eingeteilt.</i>“</p></div>
