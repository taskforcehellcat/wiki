...
<Wiki>
  <svelte:fragment slot="content">
    ...
    <section id="Formalitäten">
      <p>Feindliche Kräfte werden innerhalb der Panzertruppen gemäß der REZ-Regel gemeldet. Eine Feindmeldung erfolgt durch die Richtungsangabe, Entfernungsangabe und der Zieldefinition des Feindes. Die Richtungsangabe erfolgt im Normalfall entsprechend einer Uhrzeit relativ zur Fahrzeugwanne oder in Gradzahlen. Die Entfernungsangabe wird in Hundert übergeben, also wird "1200 Meter" zu "Zwölfhundert Meter". Ausnahmen sind hierbei Tausenderzahlen wie 1000, 2000, usw. Die Zieldefinition erfolgt als Typdefinition des Feindes. Eine feindliche Infanteriegruppe wird als solche gemeldet und ein Fahrzeug wird entsprechend der vorgesehenen Akronyme durchgegeben.</p>
    ...
    <section id="Funk">
      <p>Die Kommunikation der Panzertruppen hat einen immensen Einfluss auf ihre Effizienz und Wirkung. Der Funk muss nach dem Leitsatz "So viel wie nötig, so wenig wie möglich" erfolgen. Das konkrete Ziel eines Kampfverbandes ist die Bündelung der Feuerkraft und das gegenseitige Schützen.</p>
